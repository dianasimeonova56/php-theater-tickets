...
<body id="page-top">
    ...
    <section class="page-section ">
        <div class="container pt-5">
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Edit play</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7">
                    <form id="editPlayForm" enctype="multipart/form-data">
                        <input type="hidden" id="playId" name="playId" value="<?php echo $play['id']; ?>" />
                        <div class="form-floating mb-3">
                            <input class="form-control" id="name" name="playName" type="text" placeholder="Enter play name" required />
                            <label for="name">Play name</label>
                        </div>
                        <div class="form-floating mb-3">
                            <textarea class="form-control" id="description" name="description" required></textarea>
                            <label for="password">Play description</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="date" name="playDate" type="date" required />
                            <label for="name">Play date</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="duration" name="playDuration" type="number" step="10" required />
                            <label for="name">Play duration (in minutes)</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="image" name="playImg" type="file" />
                            <label for="name">Play image</label>
                        </div>
                        <button class="btn btn-primary btn-xl" id="editPlayBtn" type="submit">Edit play</button>
                    </form>
                </div>
            </div>
        </div>
