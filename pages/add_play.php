...
<body id="page-top">
    ...
    <section class="page-section ">
        <div class="container pt-5">
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Add play</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7">
                    <form id="addPlayForm" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="image" name="playImg" type="file" required />
                            <label for="name">Play image</label>
                        </div>
                        <button class="btn btn-primary btn-xl" id="addPlayBtn" type="submit">Add play</button>
                    </form>
                </div>
            </div>
        </div>
