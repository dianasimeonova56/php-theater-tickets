...
<body id="page-top">
    ...
    <section class="page-section myProfile" id="register">
            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    ...
                    <form id="myProfileForm">
                        ...
                        <button class="btn btn-primary btn-xl" id="submitBtn" type="submit">Edit profile</button>
                    </form>
                    <form id="changePassword">
                        ...
                        <button class="btn btn-primary btn-xl" id="submitBtn" type="submit">Change Password</button>
                    </form>
                </div>
                <div class="col-6">
                    <h2 class="page-section-heading text-center text-uppercase text-secondary">Your Bookings</h2>
                    <div class="divider-custom">
                        <div class="divider-custom-line"></div>
                        <div class="divider-custom-icon"><i class="fa-solid fa-ticket"></i></div>
                        <div class="divider-custom-line"></div>
                    </div>
                    <div class="row justify-content-center" id="bookingsGrid">
                    </div>
                </div>
            </div>
