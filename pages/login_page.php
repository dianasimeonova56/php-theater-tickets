                    ...
                    <div class="col-lg-8 col-xl-7">
                        <form id="loginForm">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="usernameOrEmail" name="usernameOrEmail" type="text" placeholder="Enter your name or email..." required />
                            ...
                            <button class="btn btn-primary btn-xl" id="loginBtn" type="submit">Login</button>
                        </form>
                    </div>
                </div>
            </div>
